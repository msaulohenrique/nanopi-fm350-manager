...
Flashez directement `{args.image}` avec Raspberry Pi Imager ou balenaEtcher et vérifiez `SHA256SUMS`. Les commits amont exacts figurent dans `source-lock.json` (empreinte `{fingerprint}`).
"""
